...
//topOne([4,5,7,2])                     //swift 2
topOne(seq: [4,5,7,2])                  //swift 3
//topOne(["Hello","Swift"])             //swift 2
topOne(seq: ["Hello","Swift"])          //swift 3
//topOne([a,b,c,liuyubobobo])           //swift 2
topOne(seq: [a,b,c,liuyubobobo])        //swift 3


//func topPrizableOne<T: protocol<Comparable, Prizable>>(seq:[T]) -> T?{         //swift 2
...
//topPrizableOne(students)?.name           //swift 2
